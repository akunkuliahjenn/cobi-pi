            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-8">
                    <div class="flex items-center mb-6">
                        <div class="p-2 <?php echo ($type == 'pemasukan') ? 'bg-green-100' : 'bg-red-100'; ?> rounded-lg mr-3">
                            <svg class="w-6 h-6 <?php echo ($type == 'pemasukan') ? 'text-green-600' : 'text-red-600'; ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex justify-between items-center mb-6">
                            <div class="flex items-center">
                                <div class="p-2 <?php echo ($type == 'pemasukan') ? 'bg-green-100' : 'bg-red-100'; ?> rounded-lg mr-3">
                                    <svg class="w-5 h-5 <?php echo ($type == 'pemasukan') ? 'text-green-600' : 'text-red-600'; ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
